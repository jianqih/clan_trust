...
ind_df_join <- left_join(ind_df_fil,cfps2014comm_2,by="cid14")
...
covar_label <-  c("大姓占比", "年龄","是否为少数民族", "个人对数收入", "受教育水平", "性别","是否党员","是否已婚","家庭规模","家庭对数收入","村庄是否为少数民族聚集区","村庄到县城距离","村庄人均对数收入","村庄常住人口数")
